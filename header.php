        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
              ...
              <?php 
                    if(isset($_SESSION['is_Login'])){
                      echo '<a class="nav-link ' . (($active == "dashboard" || $active == "history" || $active == "feedback") ? 'active1' : '') 
                          . '" href="dashboard.php">Donor Corner</a>
                        <a href="user_login/logout-user.php"><button type="button" style="width:160px; height:40px" class="btn btn-light">Logout</button></a>';
                      }
      
                      else{
                        echo'<a href="user_login/login-user.php"><button type="button" style="width:160px; height:40px" 
                        class="btn btn-light">Login / Register</button></a>';
                      }
              ?>
